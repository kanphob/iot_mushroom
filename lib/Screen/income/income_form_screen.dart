...
import 'package:siwat_mushroom/provider/income/income_form_provider.dart';
...
class IncomeFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      builder: (context, _) {
        return Consumer<IncomeFormProvider>(builder: (context, data, _) {
          if (data.bFirst) {
            return Scaffold(
  ...
  _buildDateSave(IncomeFormProvider data) {
  ...
  _buildHeadProd(IncomeFormProvider data) {
  ...
  _buildItem(IncomeFormProvider data) {
  ...
  _item({
    required IncomeFormProvider data,
  ...
  _btnAddDelete(IncomeFormProvider data) {
    return Padding(
  ...
  _buildSum(IncomeFormProvider data) {
    return data.widget.outlineListItem(
      child: Row(
        mainAxisSize: MainAxisSize.max,
